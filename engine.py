...
5. IT MUST NOT SEND ANY MESSAGE GENERATED BY ITS OWN WHEN API IS CALLED FOR ADD OR DELETE USER OR TASK CREATION OR PERFORMANCE REPORT OR EMPLOYEES UNDER ME OR TASK STATUS UPDATE, NO CONFIRMATION NO NOTHING
